...
def test_search_decisions(temp_db):
    manager, _ = temp_db
    manager.add_decision({
        "title": "Database Choice", "context": "Need storage", "chosen_option": "SQLite", "rationale": "Simple"
    })
    manager.add_decision({
        "title": "UI Framework", "context": "Need frontend", "chosen_option": "React", "rationale": "Popular"
    })
